...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/07/26 11:51:12 by qpupier           #+#    #+#              #
#    Updated: 2021/07/26 13:49:33 by qpupier          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #

import utils as __utils__
import bonus.utils as __bonus__
import bonus.degree2.neg._b.not_a as __other__
	...
	if b == int(b) :
		...
		if delete and delete != [1] :
			...
			if len(primes1) > 1 or len(primes2) > 1 :
				...
				print("	" + var + "_2 = " + str_b + " + " + str_i)
	if delta == int(delta) :
		return __other__.delta_neg_b_nota_sqrt(var, b / a1, str_b, delta)
