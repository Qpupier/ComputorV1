...
#    Updated: 2021/07/19 16:40:14 by qpupier          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
def	delta_neg_b_a_sqrt_aneg_not(var, a, b, delta_sqrt, p) :
	print("TO DO")
	return "", ""
...
def	delta_neg_b_a_sqrt_aneg(var, a, b, delta_sqrt, p) :
	...
	print("	" + var + "_2 = (" + str_b + " - " + str_delta_sqrt + "i) / " + str_a)
	if str_a == "1" :
		return delta_neg_b_a_sqrt_aneg_not(var, a, b, delta_sqrt, p)
	print()
