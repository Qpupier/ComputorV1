...
#    Updated: 2021/08/18 12:21:47 by qpupier          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
def	delta_pos_b_nota_notsqrt_delta(var, b, delta, sqrt_delta, p) :
	squares, delta_num = __bonus__.reduce_sqrt(delta)
	if not squares :
		return __not_squares__.delta_pos_b_nota_notsqrt_delta_notsquares(var, b, delta, sqrt_delta, p)
	return __squares__.delta_pos_b_nota_notsqrt_delta_squares(var, b, squares, delta_num, p)
