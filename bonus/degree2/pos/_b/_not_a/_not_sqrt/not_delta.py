...
#    Updated: 2021/08/21 18:04:46 by qpupier          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
def	delta_pos_b_nota_notsqrt_notdelta(var, b, delta, p) :
	...
	if delta_den_sqrt != int(delta_den_sqrt) :
		...
		str_den = __utils__.ft_round(delta_den, 0)
		print()
		print("<=>	" + var + "_1 = " + str_b + " - √" + str_num + "√" + str_den + " / " + str_den)
		print("	\33[33mor\033[32m")
		print("	" + var + "_2 = " + str_b + " + √" + str_num + "√" + str_den + " / " + str_den)
		print()
		print("<=>	" + var + "_1 = " + str_b + " - √(" + str_num + " * " + str_den + ") / " + str_den)
		print("	\33[33mor\033[32m")
		print("	" + var + "_2 = " + str_b + " + √(" + str_num + " * " + str_den + ") / " + str_den)
		delta_num *= delta_den
		return __delta_den__.delta_pos_b_nota_notsqrt_notdelta_deltaden(var, b, delta_num, delta_den, p)
