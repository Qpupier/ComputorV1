...
#    Updated: 2021/08/21 18:05:43 by qpupier          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
def	delta_pos_b_nota_notsqrt(var, b, delta, sqrt_delta, p) :
	if not '.' in __utils__.ft_round(delta, p) :
		return __delta__.delta_pos_b_nota_notsqrt_delta(var, b, int(delta), sqrt_delta, p)
	return __not_delta__.delta_pos_b_nota_notsqrt_notdelta(var, b, delta, p)
